...
class a_star:
    ...
    def get_neighbors(grid,cell):
        ...
        if cell.row < cell.total_rows - 1 and cell.col < cell.total_rows - 1 and not grid[cell.row + 1][cell.col + 1].is_barrier(): # DOWN RIGHT
            neighbors.append(grid[cell.row + 1][cell.col + 1])

        if cell.row < cell.total_rows - 1 and cell.col > 0 and not grid[cell.row + 1][cell.col - 1].is_barrier(): # DOWN LEFT
            neighbors.append(grid[cell.row + 1][cell.col - 1])

        if cell.row > 0 and cell.col < cell.total_rows - 1 and not grid[cell.row - 1][cell.col + 1].is_barrier(): # UP RIGHT
            neighbors.append(grid[cell.row - 1][cell.col + 1])

        if cell.row > 0 and cell.col > 0 and not grid[cell.row - 1][cell.col - 1].is_barrier(): # UP LEFT
            neighbors.append(grid[cell.row - 1][cell.col - 1])
